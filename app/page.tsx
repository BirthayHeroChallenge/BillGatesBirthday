          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 justify-center items-center">
              <a
                ...
                className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white hover:text-white transition-all duration-200"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                ...
                className="w-10 h-10 bg-sky-500 rounded-full flex items-center justify-center text-white hover:text-white transition-all duration-200"
                aria-label="Twitter"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                ...
                className="w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center text-white hover:text-white transition-all duration-200"
                aria-label="LinkedIn"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                ...
                className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white hover:text-white transition-all duration-200"
              ...
              <a
                ...
                className="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center text-white hover:text-white transition-all duration-200"
                aria-label="YouTube"
              >
                <svg
                  className="w-5 h-5"

      ...
      <div id="journey" className="py-24 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">
            Watch Bill's Journey
          </h3>
          <p className="text-lg text-slate-600 mb-12 max-w-2xl mx-auto">
            A visual journey through Bill Gates' life, from his early days to
            his transformative impact on technology and philanthropy.
          </p>
        ...
        <div id="about" className="py-16 px-4 bg-gray-50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6 text-lg text-slate-600">
              <p>
                Join us in celebrating Bill Gates' 70th birthday - a milestone
                that marks seven decades of innovation, leadership, and
                philanthropy.
              </p>
              <p className="mb-6">
                The celebration of Bill Gates' 70th birthday honors his significant
                legacy of generosity and innovation that has positively impacted
                humanity for decades.
              </p>
              <p>
                The celebration of Bill Gates's 70th birthday is being organized by
                friends and volunteers who are inspired by his significant
                philanthropic impact around the world. This special event serves as
                a heartfelt tribute to the lives he has influenced and the positive
                changes he continues to inspire.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-12 px-4 bg-white border-t border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center items-center gap-6">
            ...
            <a
              href="#"
              className="w-12 h-12 bg-sky-500 hover:bg-sky-600 rounded-full flex items-center justify-center text-white transition-colors duration-200 shadow-lg hover:shadow-xl"
              aria-label="Twitter"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="#"
              className="w-12 h-12 bg-blue-700 hover:bg-blue-800 rounded-full flex items-center justify-center text-white transition-colors duration-200 shadow-lg hover:shadow-xl"
              aria-label="LinkedIn"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="#"
              className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center text-white transition-all duration-200 shadow-lg hover:shadow-xl"
          ...
          <p className="text-slate-600 mt-6">
            Share your memories and join the global celebration using{" "}
            <span className="font-semibold text-blue-600">#BillGates70</span>
          </p>
        </div>
      </div>
